    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
      <div class="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li class="text-sm text-gray-400">Landing Page</li>
            <li class="text-sm text-gray-400">App Web & SaaS</li>
            <li class="text-sm text-gray-400">AI Integration</li>
            <li class="text-sm text-gray-400">Automazioni n8n</li>
          </ul>
        </div>
